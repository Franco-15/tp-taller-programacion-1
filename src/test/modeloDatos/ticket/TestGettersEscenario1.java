...
public class TestGettersEscenario1 {
	...
	public void setUp(){
		try {
			...
			ticketEmpledor = new Ticket(Constantes.HOME_OFFICE, 10000, Constantes.JORNADA_MEDIA, Constantes.JUNIOR, Constantes.EXP_NADA, Constantes.PRIMARIOS);
