...
public class TestGettersEscenario2 {
	...
	public void setUp(){
		try {
			...
			ticketEmpledor = new Ticket(Constantes.PRESENCIAL, 40000, Constantes.JORNADA_COMPLETA, Constantes.SENIOR, Constantes.EXP_MEDIA, Constantes.SECUNDARIOS);
	...
	public void test_get_comparacion_estudios_primarios() {
		...
		Assert.assertEquals(-0.5, ticketEmpledor.getComparacionEstudios(ticketEmpledoPretenso), 0); 
	}
	...
	public void test_get_comparacion_experiencia_nada() {
		Ticket ticketEmpledoPretenso = new Ticket(Constantes.HOME_OFFICE, 20000, Constantes.JORNADA_MEDIA, Constantes.JUNIOR, Constantes.EXP_NADA, Constantes.PRIMARIOS);
		Assert.assertEquals(-0.5, ticketEmpledor.getComparacionExperiencia(ticketEmpledoPretenso), 0); 
	}
	...
	public void test_get_comparacion_jornada_media() {
		Ticket ticketEmpledoPretenso = new Ticket(Constantes.HOME_OFFICE, 20000, Constantes.JORNADA_MEDIA, Constantes.JUNIOR, Constantes.EXP_NADA, Constantes.PRIMARIOS);
		Assert.assertEquals(-0.5, ticketEmpledor.getComparacionJornada(ticketEmpledoPretenso), 0); 
	}
	...
	public void test_get_comparacion_puesto_junior() {
		Ticket ticketEmpledoPretenso = new Ticket(Constantes.HOME_OFFICE, 20000, Constantes.JORNADA_MEDIA, Constantes.JUNIOR, Constantes.EXP_NADA, Constantes.PRIMARIOS);
		Assert.assertEquals(-0.5, ticketEmpledor.getComparacionPuesto(ticketEmpledoPretenso), 0); 
	}
	...
	public void test_get_comparacion_puesto_remuneracion_mas_v2() {
		...
		Assert.assertEquals(-0.5, ticketEmpledor.getComparacionRemuneracion(ticketEmpledoPretenso), 0); 
	}
	
	@Test
	public void test_get_comparacion_total_1() {
		Ticket ticketEmpledoPretenso = new Ticket(Constantes.HOME_OFFICE, 10000, Constantes.JORNADA_MEDIA, Constantes.JUNIOR, Constantes.EXP_NADA, Constantes.PRIMARIOS);
		Assert.assertEquals(-2, ticketEmpledor.getComparacionTotal(ticketEmpledoPretenso), 0); 
	}
	...
	public void test_get_comparacion_total_3() {
		...
		Assert.assertEquals(0.5, ticketEmpledor.getComparacionTotal(ticketEmpledoPretenso), 0); 
	}
